...
def apply_low_pass_filter_rgb(input_path, output_path):
...
output_root_folder = 'low_Pass_gauss_Filtered_Images_RGB/'
    ...
    if os.path.isdir(folder_path):
        ...
        for filename in os.listdir(folder_path):
            if filename.lower().endswith(('.jpg', '.png')):
                ...
                apply_low_pass_filter_rgb(input_path, output_path)
